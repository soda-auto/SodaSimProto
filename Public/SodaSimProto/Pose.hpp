...
#include <ostream>
#include <sstream>
#include "SodaSimProto/Common.hpp"
...
void SODASIMPROTO_API write(std::ostream & out, Pose3d const& pose);
void SODASIMPROTO_API read(std::istream & in, Pose3d & pose);
void SODASIMPROTO_API write(std::ostream & out, Pose2d const& pose);
void SODASIMPROTO_API read(std::istream & in, Pose2d & pose);
